...
#include "../../Intuitive/vrep/setup.h"
...
QT_MOC_LITERAL(1, 6, 14), // "setup_finished"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 12), // "setup_failed"
QT_MOC_LITERAL(4, 35, 14) // "start_setuping"

    },
    "Setup\0setup_finished\0\0setup_failed\0"
    "start_setuping"
};
...
void Setup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setup_finished((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 1: _t->setup_failed(); break;
        case 2: _t->start_setuping(); break;
        default: ;
        }
        ...
        {
            typedef void (Setup::*_t)(QString , QString , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Setup::setup_finished)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Setup::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Setup::setup_failed)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject Setup::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Setup.data,
      qt_meta_data_Setup,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void Setup::setup_finished(QString _t1, QString _t2, int _t3)
{
